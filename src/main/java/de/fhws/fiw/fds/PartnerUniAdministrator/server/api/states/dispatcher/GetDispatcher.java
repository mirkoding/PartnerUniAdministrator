...
public class GetDispatcher extends AbstractGetDispatcherState<Response> {
      ...
      protected void defineTransitionLinks() {
            addLink(UniversityURI.REL_PATH + "?offset={OFFSET}&size={SIZE}", UniversityRelTypes.GET_ALL_UNIVERSITIES, MediaType.APPLICATION_JSON, getAcceptRequestHeader());
            addLink(UniversityURI.REL_PATH + "?search={SEARCH}&offset={OFFSET}&size={SIZE}", UniversityRelTypes.GET_ALL_UNIVERSITIES_BY_FILTER, MediaType.APPLICATION_JSON, getAcceptRequestHeader());
